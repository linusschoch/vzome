...
export const ClassicEditor = ( props ) =>
{
  ...
  let alertRoot;
  return (
    <div id='classic' ref={alertRoot} style={{ display: 'grid', 'grid-template-rows': '1fr', 'background-color':'#f5f5f5', color:'#111' }} class='whitesmoke-bkgd'>
      <div class='editor-main grid-cols-1-min whitesmoke-bkgd' style={{ 'background-color':'#f5f5f5' }} >

  <div id='editor-canvas' style={{ display: 'grid', 'grid-template-rows': 'min-content min-content 1fr min-content', 'background-color':'#f5f5f5' }}>
          <ToolFactoryBar/>
  ...
  <div class='editor-drawer grid-rows-min-1 relative-h100' style={{ 'background-color':'#f5f5f5' }}>
          <CameraControls/>
